        ...
        <div className="mb-8 flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div className="space-y-2">
            <div className="mb-2 flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-green-700">
              <Sparkles size={14} />
              <span>Phiên #8824</span>
            </div>
            <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 md:text-5xl">
              Tái tạo vật liệu <span className="italic text-green-700">dùng một lần</span>
            </h1>
          </div>
          <Link
            to="/crafting"
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
          <div className="relative min-h-[400px] overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm md:col-span-7">
            ...
            <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between rounded-2xl border border-white/30 bg-white/20 p-5 backdrop-blur">
              <div>
                <p className="mb-1 text-[10px] font-bold uppercase tracking-widest text-white/80">Vật liệu nhận diện</p>
                <h3 className="text-xl font-bold text-white">Thủy tinh trong</h3>
              </div>
              <div className="rounded-full bg-green-700/90 px-3 py-1.5 text-xs font-bold text-white">Khớp 98.2%</div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 md:col-span-5">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-3">
                <div className="rounded-xl bg-slate-100 p-3 font-bold">Có thể tái chế</div>
                <div className="rounded-xl bg-slate-100 p-3 font-bold">Chai thủy tinh</div>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-green-200 bg-green-50 p-6">
              ...
              <div className="flex items-center gap-4 rounded-2xl bg-white p-3">
                ...
                />
                <div>
                  <h5 className="text-sm font-bold text-slate-900">Vườn cây tự tưới</h5>
                  <p className="text-xs text-slate-500">45 phút • Trung bình</p>
                </div>
